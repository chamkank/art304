...
let commentString = 'CREATE TABLE IF NOT EXISTS Comment(comment_id char(20) primary key,artist_username varchar(20) references Artist_Wall(username) ON DELETE CASCADE ON UPDATE CASCADE, date_posted timestamp, comment_text varchar(250));';
...
pool.query(tagString + artistWallString + followsString + artString + commentString + likesString + hasString + commentsOnString, (err, res) => {
    if(err) {
        return console.error('error running query', err);
    }
    pool.query(tagInsert1 + tagInsert2 + tagInsert3 + tagInsert4 + tagInsert5 + artistWallInsert1 + artistWallInsert2 + artistWallInsert3 + artistWallInsert4 + artistWallInsert5 + artInsert1 + artInsert2 + artInsert3 + artInsert4 + artInsert5 + commentInsert1 + commentInsert2 + commentInsert3 + commentInsert4 + commentInsert5 + followsInsert1 + followsInsert2 + followsInsert3 + followsInsert4 + followsInsert5 + hasInsert1 + hasInsert2 + hasInsert3 + hasInsert4 + hasInsert5 + commmentsOnInsert1 + commmentsOnInsert2 + commmentsOnInsert3 + commmentsOnInsert4 + commmentsOnInsert5 + likesInsert1 + likesInsert2 + likesInsert3 + likesInsert4 + likesInsert5, (err, res) => {
