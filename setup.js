...
let artistWallString = 'CREATE TABLE IF NOT EXISTS Artist_Wall(username varchar(20) primary key, password varchar(20) NOT NULL, email_address varchar(254) unique NOT NULL, date_joined timestamp NOT NULL, birth_date date CHECK (birth_date < \'2018-01-1\') NOT NULL);';
